...
{
    public class When_Subscribing_To_Secondary_Tile_Notification_On_Registered_Client : With<Client, SubscribeCommand>
    {
        ...
        {
            AssertEvent.Contents<SubscribedEvent>(0, e => Assert.Equal("/Page1.xaml?test=test", e.ParamUri));
        }
